$(function() {
    ...
    optionPie.title.text="医疗器械流通监管检查情况（监督分类）"
    ...
    pie4option.title.text="医疗器械生产监管检查结果情况（专项检查)"
    myChartpie4.setOption(pie4option);
    pie4option.title.text="医疗器械生产监管检查结果情况（飞行检查)"
    myChartpie5.setOption(pie4option)
    pie4option.title.text="医疗器械流通监管检查结果情况（日常检查)"
    myChartpie8.setOption(pie4option)
    pie4option.title.text="医疗器械流通监管检查结果情况（专项检查)"
    myChartpie9.setOption(pie4option)
    pie4option.title.text="医疗器械流通监管检查结果情况（飞行检查)"
    ...
    optionPie5.title.text="医疗器械专项检查情况（企业类型）"

    myChartpie12.setOption(optionPie5)
    optionPie5.title.text="医疗器械飞行检查情况（企业类型）"
