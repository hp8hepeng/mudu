$(function() {
    ...
    config = {}
    setTimeout(() => {
        config.a1 = $('#fd-E01').EasyChart({'title':"医疗器械抽验情况"}, 'qthxt', function(parme) {
        // 回调 点击事件
        // alert("aaa")
        console.log(parme)
    })
    ...
    config.a3 = $('#fd-E03').EasyChart({'title':'医疗器械产品分类抽样情况'}, 'twoBar', function(parme) {
        // 回调 点击事件
        console.log(parme)
    })
    ...
    config.a7 = $('#fd-E07').EasyChart({"title":'医疗器械产品分类抽样情况'}, 'twobar2', function(parme) {
        // 回调 点击事件
        console.log(parme)
    })
}, 50)
