...
MapCharts.prototype = {
    ...
    setOption: function(options) {
        ...
        _this.defaultOptions = {
            ...
            mapStyle: {
                ...
                areaMap: {
                    fill: 'rgba(129,197,240,.2)',
                    stroke: '#fff',
                    strokeWidth: 15,
                    outlineStroke: '#fff',
                    outlineFill: '#fff',
                    textFill: '#fff',
                    hoverFill: 'rgba(206,203,128, .8)', //地图划过区域颜色
                    clickFill: 'rgba(206,203,128, .8)', //地图点击区域颜色
                    clickStroke: '#fff' //地图点击区域描边颜色
                },
                circle: {
                    stroke: '#ffc320',
                    r: 50,
    ...
    init: function() {
        var _this = this;
        //请求svg地图
        _this.requestSvgMap('../../../mudu/svg/mapid-' + _this.opts.mapId + '.svg');
    },
    /*
     * 设置svg地图
     * */
